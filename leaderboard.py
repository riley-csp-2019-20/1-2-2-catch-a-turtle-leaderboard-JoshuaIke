...
def load_leaderboard(file_name, leader_names, leader_scores):
  ...
  for line in leaderboard_file:
    ...
    # TODO 1: use a while loop t,o read the leader name from the line (format is "leader_name,leader_score")
    while (line[index] != ","):
  ...
  #print(leader_name)    
    ...
    leader_names.append(int(leader_name))
...
# ["Jesus", "Mohammad", "Tremmel"], [30, 15, 7], "Josh", 10)
